...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        ...
        <div class="main-header-con" :style="{paddingLeft: shrink?'60px':'170px'}">
            ...
            <div style="background-image: linear-gradient( 135deg, #F0A70A 10%, #0D25B9 100%);text-align: center;height:30px;line-height:30px;letter-spacing: 1px;color:#FFF;">这只是一个测试站，请勿充值！购买商用系统请联系 商务QQ:247818019 技术CTO QQ:1771126648（唯一渠道，谨防被骗）</div>
            <div class="tags-con">
