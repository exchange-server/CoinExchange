...
<!-- 						<FormItem>
		...
		<div style="position:absolute;top: 10px;font-size: 14px;margin-top: 10px;margin-left: 30px;color:rgb(255 238 211);text-shadow: 1px 0px 2px #000;width: 400px;text-align: left;border-radius: 5px;padding: 5px 0;">这只是一个测试站，请勿充值！购买商用系统请联系 商务QQ:247818019 技术CTO QQ:1771126648（唯一渠道，谨防被骗）</div>
	</div>
</template>
